...
EigenfunctionCalculator::EigenfunctionCalculator(Matslise *ms, double E, const Y<double> &left, const Y<double> &right) : ms(ms), E(E) {
...
EigenfunctionCalculator &EigenfunctionCalculator::operator=(const EigenfunctionCalculator &ec) {
    ms = ec.ms;
    E = ec.E;
    if (ys != NULL)
        delete[] ys;
